...
describe('lessThanEqual', () => {
  it('basic (1D Tensor)', () => {
    ...
    expectArraysClose(r.toBool8Array(), [1, 0, 1])

    a = sm.tensor(new Float32Array([2, 2, 2]))
    b = sm.tensor(new Float32Array([2, 2, 2]))
    r = a.lessThanEqual(b)
    expect(isShape(r, [3])).toBe(true)
    expectArraysClose(r.toBool8Array(), [1, 1, 1])
  ...
  it('3D Tensor', () => {
    ...
    r = sm.lessThanEqual(a, b)
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [1, 1, 1, 1, 1, 1])
    ...
    r = sm.lessThanEqual(a, b)
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [1, 1, 1, 1, 1, 0])
  })
  it('3D Tensor with NaNs', () => {
    ...
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [0, 0, 1, 1, 1, 0])
  })
  it('4D Tensor', () => {
