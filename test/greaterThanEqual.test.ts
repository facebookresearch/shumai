...
describe('greaterThanEqual', () => {
  it('basic (1D Tensor)', () => {
    ...
    expectArraysClose(r.toBool8Array(), [0, 1, 1])
    ...
    expectArraysClose(r.toBool8Array(), [0, 0])
  ...
  it('2D Tensor', () => {
    ...
    expectArraysClose(r.toBool8Array(), [0, 1, 0, 1, 0, 1])
  ...
  it('4D Tensor', () => {
    ...
    expectArraysClose(r.toBool8Array(), [0, 1, 0, 1])
