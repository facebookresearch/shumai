...
describe('transpose', () => {
  it('2D Tensor (no change)', () => {
    ...
    expectArraysClose(<Float32Array>r.valueOf(), <Float32Array>t.valueOf())
  })
  ...
  it('2D Tensor', () => {
    ...
    expectArraysClose(<Float32Array>t.valueOf(), [1, 3, 11, 33, 2, 4, 22, 44])
  })
  ...
  it('3D Tensor [r, c, d] => [d, r, c]', () => {
    ...
    expectArraysClose(<Float32Array>t2.valueOf(), [1, 2, 3, 4, 11, 22, 33, 44])
  })
  ...
  it('3D Tensor [r, c, d] => [r, d, c]', () => {
    ...
    expectArraysClose(<Float32Array>tt.valueOf(), [1, 3, 2, 4, 5, 7, 6, 8])
  })
