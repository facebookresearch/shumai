...
describe('greaterThan', () => {
  ...
  it('2D Tensor', () => {
    ...
    expectArraysClose(r.toBool8Array(), [0, 1, 0, 1, 0, 0])
    ...
    expectArraysClose(r.toBool8Array(), [0, 0, 0, 0])
  ...
  it('2D Tensor with NaNs', () => {
    ...
    const r = sm.greaterThan(a, b)
    expect(isShape(r, [2, 2])).toBe(true)
    expectArraysClose(r.toBool8Array(), [1, 0, 0, 0])
  })
  it('3D Tensor', () => {
    ...
    r = sm.greaterThan(a, b)
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [0, 0, 0, 0, 0, 0])
    ...
    r = sm.greaterThan(a, b)
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [0, 0, 0, 0, 0, 1])
  })
  it('3D Tensor with NaNs', () => {
    ...
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [1, 0, 0, 0, 0, 0])
  })
  it('4D Tensor', () => {
    ...
    expectArraysClose(r.toBool8Array(), [0, 1, 0, 0])
    ...
    r = sm.greaterThan(a, b)
    expect(isShape(r, [2, 2, 1, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [1, 1, 1, 1])
