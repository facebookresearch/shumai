...
describe('lessThan', () => {
  it('basic (1D Binary Tensor)', () => {
    ...
    expectArraysClose(r.toBool8Array(), [1, 0, 1, 0])
  })
  it('basic (1D Tensor)', () => {
    ...
    expectArraysClose(r.toBool8Array(), [1, 0, 0])
  ...
  it('2D Tensor', () => {
    ...
    expectArraysClose(r.toBool8Array(), [1, 0, 1, 0, 1, 0])
  ...
  it('2D Tensor with NaNs', () => {
    ...
    const r = sm.lessThan(a, b)
    expect(isShape(r, [2, 2])).toBe(true)
    expectArraysClose(r.toBool8Array(), [0, 0, 1, 0])
  })
  it('3D Tensor', () => {
  ...
  it('3D Tensor with NaNs', () => {
    ...
    const r = a.lessThan(b)
    expect(isShape(r, [2, 3, 1])).toBe(true)
    expectArraysClose(r.toBool8Array(), [0, 0, 0, 1, 0, 0])
  })
  it('4D Tensor', () => {
