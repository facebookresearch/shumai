...
export const gen_tensor_op_shim = (wrapFunc: Function) => {
  return {
    reshape(shape: number[]) {
      const t = wrapFunc(fl._reshape.native, this, ...arrayArg(shape, FFIType.i64));
      t.op = "reshape";
      t.grad_fn = null;
      return t;
    },
    ...
    transpose(axes: number[]) {
      const t = wrapFunc(fl._transpose.native, this, ...arrayArg(axes, FFIType.i64));
      t.op = "transpose";
      t.grad_fn = null;
      return t;
    },
    ...
    tile(shape: number[]) {
      const t = wrapFunc(fl._tile.native, this, ...arrayArg(shape, FFIType.i64));
      t.op = "tile";
      t.grad_fn = null;
      return t;
    },
    ...
    flip(dim: number) {
      const t = wrapFunc(fl._flip.native, this, dim);
      t.op = "flip";
      t.grad_fn = null;
      return t;
    },
    ...
    roll(shift: number, axis: number) {
      const t = wrapFunc(fl._roll.native, this, shift, axis);
      t.op = "roll";
      t.grad_fn = null;
      return t;
    },
    ...
    sort(dim: number) {
      const t = wrapFunc(fl._sort.native, this, dim);
      t.op = "sort";
      t.grad_fn = null;
      return t;
    },
    ...
    amin(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._amin.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "amin";
      t.grad_fn = null;
      return t;
    },
    ...
    amax(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._amax.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "amax";
      t.grad_fn = null;
      return t;
    },
    ...
    argmin(axis: number, keep_dims: boolean = false) {
      const t = wrapFunc(fl._argmin.native, this, axis, keep_dims);
      t.op = "argmin";
      t.grad_fn = null;
      return t;
    },
    ...
    argmax(axis: number, keep_dims: boolean = false) {
      const t = wrapFunc(fl._argmax.native, this, axis, keep_dims);
      t.op = "argmax";
      t.grad_fn = null;
      return t;
    },
    ...
    sum(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._sum.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "sum";
      t.grad_fn =   (grad) => {
    ...
    cumsum(axis: number) {
      const t = wrapFunc(fl._cumsum.native, this, axis);
      t.op = "cumsum";
      t.grad_fn = null;
      return t;
    },
    ...
    mean(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._mean.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "mean";
      t.grad_fn =   (grad) => {
        const T = grad.in[0].constructor;
    ...
    median(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._median.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "median";
      t.grad_fn = null;
      return t;
    },
    ...
    _var(axes: number[] = [], bias: boolean = false, keep_dims: boolean = false) {
      const t = wrapFunc(fl._var.native, this, ...arrayArg(axes, FFIType.i32), bias, keep_dims);
      t.op = "var";
      t.grad_fn = null;
      return t;
    },
    ...
    std(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._std.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "std";
      t.grad_fn = null;
      return t;
    },
    ...
    norm(axes: number[] = [], p: number = 2, keep_dims: boolean = false) {
      const t = wrapFunc(fl._norm.native, this, ...arrayArg(axes, FFIType.i32), p, keep_dims);
      t.op = "norm";
      t.grad_fn = null;
      return t;
    },
    ...
    countNonzero(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._countNonzero.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "countNonzero";
      t.grad_fn = null;
      return t;
    },
    ...
    any(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._any.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "any";
      t.grad_fn = null;
      return t;
    },
    ...
    all(axes: number[] = [], keep_dims: boolean = false) {
      const t = wrapFunc(fl._all.native, this, ...arrayArg(axes, FFIType.i32), keep_dims);
      t.op = "all";
      t.grad_fn = null;
      return t;
    },
